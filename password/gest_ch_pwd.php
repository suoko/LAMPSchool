...
*/
	...
	//Esecuzione query
	$sql="select * from tbl_utenti where userid='$ute' and (tipo='T' or tipo='D'  or tipo='S' or tipo='A' or tipo='P')";
   // print inspref($sql);
    ...
    else
    {
        ...
        else
        {
            ...
            $query="update tbl_utenti set passprecedenti=concat(passprecedenti,password,'|'),password = md5('". $pas. "') where userid='". $ute. "'";
           // print $query;
